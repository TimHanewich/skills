...
- EVERY task you log MUST have a date **AND TIME**! Do NOT not call to the `msx` CLI to create a new task without a time specified. Unless the user specifies the time they want you to set it as, always set it to **12 PM noon**. 
